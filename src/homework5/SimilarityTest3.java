...
public class SimilarityTest3 {
    ...
    public static void main(String[] args) {
    	...
    	String str = null;
        Similarity file1 = new Similarity("I believe that is the case of correct won't be able to do  23sb_ 23b3_ 45sdb 3b tes3ts  believe that case correct of");

        printOutput(file1);
        file1.getMap().forEach((key, value) -> System.out.println(key + ":" + value));
        //Similarity file2 = new Similarity(new File("clarissa.txt"));
        Similarity file2 = new Similarity("I believe that is the case of correct won't be able to do  23sb_ 23b3_ 45sdb 3b tes3ts  believe that case correct of");
